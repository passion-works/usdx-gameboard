...
public class HotkeyController implements HotkeyListener {
    ...
    public void init(){
        ...
        JIntellitype.getInstance().registerHotKey(4,0, KeyEvent.VK_END); //reset/new round
        JIntellitype.getInstance().registerHotKey(5,0, KeyEvent.VK_HOME); //new match
        JIntellitype.getInstance().registerHotKey(6,0, KeyEvent.VK_NUMPAD0); //start countdown
